...
{
    int64_t nSubsidy = nCoinAge * 33 / (365 * 33 + 8) * (50 * CENT); // 200% Forever
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "Metropolitan is reborn on 03-12-2019.";
        CTransaction txNew;
        txNew.nTime = 1575379610;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1575379610;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = !fTestNet ? 1184294 : 1184294;
        ...
        assert(block.hashMerkleRoot == uint256("0x279be6a6ad6a11c6ba8d1e65ee107ab6b7c9059155e88c56b8da38ca7b7f5dd5"));
...
unsigned char pchMessageStart[4] = { 0x9d, 0xd6, 0x17, 0xe4 };
